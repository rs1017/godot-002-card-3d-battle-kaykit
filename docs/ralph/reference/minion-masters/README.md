...
## What Was Collected (2026-02-13)
- Collection mode: offline-fallback
- Store header and capsule images
- 8 gameplay screenshots (1920x1080)

## Sources
- Steam store: https://store.steampowered.com/app/489520/Minion_Masters/
- Steam CDN root: https://shared.fastly.steamstatic.com/store_item_assets/steam/apps/489520
